...
public interface Errors {
	...
	public static final String GENERAL_ERROR = "Sorry, we couldn't process your request at the moment. Try again later or contact the administrator.<br>Make sure both cvs files are in the correct layout, having all 8 fields withing column 'a' separated by comma,start from line 2.<br>";
